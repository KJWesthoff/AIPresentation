...
const SLIDE_IDS = [
  'ai-security-intro','ai-threat-modelling','ai-stride','ai-threat-lenses','ai-llm-security',
  'ai-owasp-consolidated','ai-agent-anatomy','ai-mcp-attack','ai-multi-agent','ai-tool-call-anatomy',
  'ai-confused-deputy','ai-toctou','ai-untrusted-input','ai-poisoned-model','ai-atlas','ai-procedure','ai-incidents','ai-sandbox-escape','ai-exotic-threats',
...
const SLOW = new Set([
  'ai-agent-anatomy','ai-multi-agent','ai-security-intro','ai-owasp-consolidated','ai-tool-call-anatomy',
